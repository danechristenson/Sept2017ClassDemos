...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <!--
        ...
        nested repeater will get it's datasource from the collection of the 
            previous DTO level (either a POCO of another DTO)
        -->
    <asp:Repeater ID="GenreAlbumTrackList" runat="server" DataSourceID="GenreAlbumTrackListODS" ItemType="Chinook.Data.DTOs.GenreDTO">
        <ItemTemplate>
            ...
            <asp:Repeater ID="AlbumTrackList" runat="server" DataSource='<%# Eval("albums") %>'
                ItemType="Chinook.Data.DTOs.AlbumDTO">
                <ItemTemplate>
                    <h4>Album: 
                    <%# string.Format("{0} ({1}) Tracks: {2}",
                                    Item.title, Eval("releaseYear"),
                                    Eval("numberOfTracks")) %>

                    </h4>
                    <asp:Repeater ID="Repeater1" runat="server" ItemType="Chinook.Data.POCOs.TrackPOCO"
                        ...
                        <ItemTemplate>
                            <tr>
                                <td style="width:600px"><a href="https://www.google.ca/search?q=<%# Item.song %>+song"><%# Item.song %></a></td>
                                <td><%# Item.length %></td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
